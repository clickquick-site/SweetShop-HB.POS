// ============================================================
//  HB-POS — app.js  v8.1.0  |  إصدار محسّن بالكامل
//  ✅ أمان متقدم  ✅ إدارة DB محكمة  ✅ أداء عالي
// ============================================================

const APP_VERSION = { number: '8.1.0', date: '2026-03', name: 'HB-POS' };
...
class ErrorLogger {
  ...
  error(context, message, err) {
    ...
    this._store(entry);
    console.error(`[HB-POS] ❌ [${context}] ${message}`, err || '');
  ...
  warn(context, message, err) {
    ...
    this._store(entry);
    console.warn(`[HB-POS] ⚠️ [${context}] ${message}`, err || '');
    window.toast?.show(`⚠️ ${message}`, 'warning', 4000);
  }

  // حالة متوقعة — console فقط بدون إزعاج
  info(context, message) {
    console.info(`[HB-POS] ℹ️ [${context}] ${message}`);
  }
...
console.log('📦 HB-POS v8.1.0 - نظام محسّن بالكامل');
